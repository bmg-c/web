...
from schemas import Register, Login, ValidateCode, Recover, Details, FullUserInfo, ChangeEmail
...
@router.post('/send_verify_code', response_model=Details)
def Send_Verification_Code(email_addr: ChangeEmail):
    return auth.send_verify_code(email_addr.email)
...
@router.post('/recover', response_model=Recover)
